 ...
 */
public class VideoDetailsFragment2 extends DetailsSupportFragment {
    private static final String TAG = "VideoDetailsFragment2";
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        mSelectedMovie =
                (Movie) getActivity().getIntent() .getSerializableExtra(DetailsActivity2.MOVIE);
    ...
    private void setupDetailsOverviewRowPresenter() {
        ...
        sharedElementHelper.setSharedElementEnterTransition(
                getActivity(), DetailsActivity2.SHARED_ELEMENT_NAME);
